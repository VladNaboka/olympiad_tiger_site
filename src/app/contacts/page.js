            ...
            <div className="relative z-10 text-center">
              ...
              <div className="bg-white text-gray-800 p-6 rounded-xl max-w-md mx-auto">
                ...
                <div className="flex items-center justify-center mb-3">
                  ...
                  <span className="text-gray-700">📞 +7 700 595 1000</span>
                </div>
        ...
        <div className="container mx-auto max-w-6xl relative">
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 relative">
            <div className="flex flex-col lg:flex-row">
              {/* Left Column - Social Media and Stay Connected */}
              <div className="lg:w-1/5 pr-8 flex flex-col">
                <div className="mb-10">
                  <h3 className="text-lg font-bold text-gray-800 mb-4">Stay connected:</h3>
                  
                  <div className="flex flex-col space-y-4">
                    <a href="https://instagram.com/tigers.olympiad" aria-label="Instagram" className="flex items-center text-orange-500 hover:text-orange-600 transition-colors">
                    ...
                    <a href="https://t.me/olympiadinkz" aria-label="Telegram" className="flex items-center text-orange-500 hover:text-orange-600 transition-colors">
                      <svg className="w-6 h-6 mr-3" fill="currentColor" viewBox="0 0 24 24">
