            ...
            <div className="relative z-10 text-center">
              ...
              <div className="bg-white text-gray-800 p-6 rounded-xl max-w-md mx-auto">
                ...
                <div className="flex items-center justify-center">
                  ...
                  <span className="text-gray-700">📧 tigersolympiad@gmail.com</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="lg:w-1/5 pr-8 flex flex-col">
                <div className="mb-10">
                  ...
                  <div className="flex flex-col space-y-4">
                    <a href="#" aria-label="Instagram" className="flex items-center text-orange-500 hover:text-orange-600 transition-colors">
                    ...
                    <a href="#" aria-label="Telegram" className="flex items-center text-orange-500 hover:text-orange-600 transition-colors">
                      <svg className="w-6 h-6 mr-3" fill="currentColor" viewBox="0 0 24 24">
